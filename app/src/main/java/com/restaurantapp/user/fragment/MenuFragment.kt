...
import com.restaurantapp.Adapter.categoryAdapter
...
class MenuFragment : Fragment() {
    ...
    private fun loadMenu() {
        ...
        FirebaseReader.getFireDataList(Category::class.java, ValueCallback { objects ->
            var list = objects as ArrayList<*> as ArrayList<Category>
