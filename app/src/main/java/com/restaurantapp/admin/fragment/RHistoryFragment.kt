...
import com.restaurantapp.Adapter.AdminReservHistoryAdapter
 ...
 * [RHistoryFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [RHistoryFragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class RHistoryFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val rootView = inflater.inflate(R.layout.fragment_rhistory, container, false)

        recyclerView=rootView.findViewById(R.id.recyclerReservHistoryAdmin)
    ...
    private fun loadMenu() {
        ...
        val adapter= AdminReservHistoryAdapter(listAdmin, context!!)
        FirebaseReader.getFireDataList(User::class.java, ValueCallback { users ->
            val list = users as ArrayList<*> as ArrayList<User>
            for (user in list){
                FirebaseReader.getFiliterdReservsHistory(TableReservation::class.java, ValueCallback { userOrders->
...
*/
    ...
    companion object {
         ...
         * @return A new instance of fragment RHistoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                RHistoryFragment().apply {
